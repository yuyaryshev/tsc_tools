...
const missingDependencies1: ReplacesDefinition = {
    replaces: [
        ...
        { from: '"YDomainRuntimeCommon"', to: '"@yuyaryshev/ydomain_common"' },
        { from: '"YtransportHasty2Client"', to: '"@yuyaryshev/ytransport_hasty2_client"' },
        { from: '"YDomainRuntimeClient"', to: '"@yuyaryshev/ydomain_client"' },
        { from: '"YDomainRuntimeServer"', to: '"@yuyaryshev/ydomain_client"' },
